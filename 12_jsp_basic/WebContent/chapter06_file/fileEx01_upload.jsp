...
<body>
	...
	<%
		...
		//파일 저장경로는 웹서비스의 접근경로가아닌
		//물리적인 실제 경로를 적어주어야한다.
		String fileSaveLocation = "C:\\Users\\19시_웹개발_LSJ\\git\\12_jsp_basic\\12_jsp_basic\\WebContent\\chapter06_file\\file_repo";
		
		int maxSize = 1024 * 1024 * 5; // 5mb 한번에 업로드될 최대 용량 지정
		...
		Enumeration<?> files = multi.getFileNames();  // input type이 file 인 모든 파라메터를 배열로 받아온다.
		
		if(files.hasMoreElements()){  // 다음 정보가 있으면 (== rs.nex() 와 유사)
